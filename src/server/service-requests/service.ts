...
export type ServiceRequestDetail = {
  ...
  countryCode:string; postalCode:string; city:string; addressLine1:string|null; assignedUserId:string|null; assigneeName:string|null; createdBy:string; updatedBy:string; createdAt:string; updatedAt:string; closedAt:string|null; archivedAt:string|null; lockVersion:number;
};
